...
const ACH_ICONS = {
  ...
  footprint:()=>`<ellipse cx="38" cy="64" rx="14" ry="21" fill="url(#iconFoot)" transform="rotate(-14 38 64)"/><circle cx="28" cy="38" r="5" fill="url(#iconFoot)"/><circle cx="38" cy="31" r="5.6" fill="url(#iconFoot)"/><circle cx="49" cy="29" r="5" fill="url(#iconFoot)"/><circle cx="59" cy="33" r="4.2" fill="url(#iconFoot)"/><ellipse cx="68" cy="58" rx="13" ry="20" fill="url(#iconFoot)" opacity="0.5" transform="rotate(12 68 58)"/><ellipse cx="33" cy="55" rx="4" ry="8" fill="#fff" opacity="0.35"/>`,
  ...
  runner:()=>`<circle cx="58" cy="22" r="7" fill="url(#iconSwimmer)"/><path d="M58 30l-8 14 12 8-2 22M50 44l-16 8M62 52l14 6-4 16M50 44l6-14 10 4" stroke="url(#iconSwimmer)" stroke-width="7" stroke-linecap="round" stroke-linejoin="round" fill="none"/>`,
  ...
  flame:()=>`<path d="M50 18c11 14-4 18-4 29a10 10 0 0020 0c0-6-2-10-5.5-13 3 13-4 17-7.5 13 5.5-11-1.5-23-5-29-1.5-1.5-2 .5-3.5 0z" fill="url(#iconFlame)"/><path filter="url(#achGlow)" d="M34 48c-5.5 7-7 14-7 21a23 23 0 0046 0c0-5.5-1-11-3.5-16" stroke="#ff8a5c" stroke-width="3.2" stroke-linecap="round" fill="none" opacity="0.85"/><ellipse cx="43" cy="30" rx="4" ry="8" fill="#fff" opacity="0.5"/>`,
  ...
  monolith:()=>`<path d="M38 26h24l4 50H34z" fill="url(#iconGraphite)"/><path d="M42 34h4v4h-4zM54 34h4v4h-4zM42 44h16v4H42z" fill="#12181f" opacity="0.5"/><ellipse cx="44" cy="34" rx="3" ry="6" fill="#fff" opacity="0.15"/>`,
  moon:()=>`<path d="M60 20a30 30 0 100 60 24 24 0 010-60z" fill="url(#iconMoon)"/><circle cx="46" cy="38" r="3" fill="#c9d1db" opacity="0.5"/><circle cx="52" cy="55" r="4" fill="#c9d1db" opacity="0.4"/>`,
  ...
  oar:()=>`<rect x="24" y="20" width="7" height="34" rx="3" fill="url(#iconBrown)" transform="rotate(-25 24 20)"/><ellipse cx="24" cy="18" rx="8" ry="13" fill="url(#iconBrown)" transform="rotate(-25 24 18)"/><rect x="69" y="20" width="7" height="34" rx="3" fill="url(#iconBrown)" transform="rotate(25 69 20)"/><ellipse cx="76" cy="18" rx="8" ry="13" fill="url(#iconBrown)" transform="rotate(25 76 18)"/><path d="M18 66c8-6 16-6 24 0s16 6 24 0 16-6 24 0" stroke="url(#iconWave)" stroke-width="5" stroke-linecap="round" fill="none"/>`,
...
const achievementDefs = [
  ...
  {id:"week_walk_5",cat:"weekly",icon:"calendar",title:"Five This Week",desc:"Walk 5 miles between Monday and Sunday.",rarity:"COMMON",goal:5,metric:"weekWalkMiles"},
  {id:"week_walk_10",cat:"weekly",icon:"cloud",title:"Double Digits",desc:"Walk 10 miles this week.",rarity:"RARE",goal:10,metric:"weekWalkMiles"},
  {id:"week_walk_20",cat:"weekly",icon:"compass",title:"Twenty Mile Week",desc:"Walk 20 miles this week.",rarity:"EPIC",goal:20,metric:"weekWalkMiles"},
  {id:"week_run_5",cat:"weekly",icon:"calendar",title:"Running Week",desc:"Run 5 miles between Monday and Sunday.",rarity:"COMMON",goal:5,metric:"weekRunMiles"},
  {id:"week_run_10",cat:"weekly",icon:"lightning",title:"Ten Mile Week",desc:"Run 10 miles this week.",rarity:"RARE",goal:10,metric:"weekRunMiles"},
  {id:"week_run_20",cat:"weekly",icon:"medal",title:"Twenty Mile Runner",desc:"Run 20 miles this week.",rarity:"EPIC",goal:20,metric:"weekRunMiles"},
  {id:"week_combo_15",cat:"weekly",icon:"globe",title:"Move 15",desc:"Walk and/or run 15 miles this week.",rarity:"RARE",goal:15,metric:"weekMoveMiles"},
  {id:"week_combo_30",cat:"weekly",icon:"rocket",title:"Thirty Mile Week",desc:"Walk and/or run 30 miles this week.",rarity:"LEGEND",goal:30,metric:"weekMoveMiles"},
  ...
  {id:"weekly_workouts_3",cat:"weekly",icon:"calendar",title:"Workout Week",desc:"Complete 3 workouts between Monday and Sunday.",rarity:"COMMON",goal:3,metric:"weekWorkouts"},
  ...
  {id:"weekly_move_40",cat:"weekly",icon:"rocket",title:"Forty Mile Week",desc:"Walk and/or run 40 miles this week.",rarity:"EPIC",goal:40,metric:"weekMoveMiles"},
  ...
  {id:"weekly_move_50",cat:"weekly",icon:"rocket",title:"Ultra Week",desc:"Walk and/or run 50 miles between Monday and Sunday.",rarity:"LEGEND",goal:50,metric:"weekMoveMiles"},
  ...
  {id:"week_swim_1",cat:"weekly",icon:"calendar",title:"Swim Week",desc:"Swim 1 mile between Monday and Sunday.",rarity:"COMMON",goal:1,metric:"weekSwimMiles"},
  {id:"week_swim_3",cat:"weekly",icon:"wave",title:"Triple Dip",desc:"Swim 3 miles between Monday and Sunday.",rarity:"RARE",goal:3,metric:"weekSwimMiles"},
  {id:"week_swim_6",cat:"weekly",icon:"trophy",title:"Six Mile Splash",desc:"Swim 6 miles between Monday and Sunday.",rarity:"EPIC",goal:6,metric:"weekSwimMiles"},
  ...
  {id:"week_cycle_15",cat:"weekly",icon:"calendar",title:"Cycle Week",desc:"Cycle 15 miles between Monday and Sunday.",rarity:"COMMON",goal:15,metric:"weekCycleMiles"},
  {id:"week_cycle_30",cat:"weekly",icon:"cloud",title:"Thirty Mile Ride Week",desc:"Cycle 30 miles between Monday and Sunday.",rarity:"RARE",goal:30,metric:"weekCycleMiles"},
  {id:"week_cycle_60",cat:"weekly",icon:"medal",title:"Sixty Mile Week",desc:"Cycle 60 miles between Monday and Sunday.",rarity:"EPIC",goal:60,metric:"weekCycleMiles"},
  ...
  {id:"week_hike_5",cat:"weekly",icon:"calendar",title:"Hike Week",desc:"Hike 5 miles between Monday and Sunday.",rarity:"COMMON",goal:5,metric:"weekHikeMiles"},
  {id:"week_hike_10",cat:"weekly",icon:"cloud",title:"Ten Mile Trail Week",desc:"Hike 10 miles between Monday and Sunday.",rarity:"RARE",goal:10,metric:"weekHikeMiles"},
  {id:"week_hike_15",cat:"weekly",icon:"medal",title:"Fifteen Mile Ridge Week",desc:"Hike 15 miles between Monday and Sunday.",rarity:"EPIC",goal:15,metric:"weekHikeMiles"},
  ...
  {id:"week_row_5",cat:"weekly",icon:"calendar",title:"Row Week",desc:"Row 5 miles between Monday and Sunday.",rarity:"COMMON",goal:5,metric:"weekRowMiles"},
  {id:"week_row_10",cat:"weekly",icon:"cloud",title:"Ten Mile Row Week",desc:"Row 10 miles between Monday and Sunday.",rarity:"RARE",goal:10,metric:"weekRowMiles"},
  {id:"week_row_20",cat:"weekly",icon:"medal",title:"Twenty Mile Row Week",desc:"Row 20 miles between Monday and Sunday.",rarity:"EPIC",goal:20,metric:"weekRowMiles"},
