...
const ACH_ICONS = {
  ...
  flame:()=>`<path d="M50 16c13 16-2 20-2 32a12 12 0 0024 0c0-7-2.5-12-6.5-15.5 3.5 15-4.5 19.5-9 15 6.5-13-1.5-27-6-31-1.5-1.5-1.5 0.5-0.5-0.5z" fill="url(#iconFlame)"/><path d="M36 52c-6.5 8-8 16-8 24a22 22 0 0044 0c0-6-1-12-3.5-17.5" stroke="#ff8a5c" stroke-width="3.5" stroke-linecap="round" fill="none" opacity="0.85"/><ellipse cx="50" cy="34" rx="3.5" ry="7" fill="#fff" opacity="0.55"/>`,
